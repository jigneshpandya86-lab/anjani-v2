    ...
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {defaulterCount > 0 && <span className="text-[10px] font-bold">{defaulterCount}</span>}
        </button>
        <button
      ...
      {filtered.map((client) => (
        <div
          key={client.id}
          className={`bg-white p-4 rounded-lg border shadow-sm ${!client.active && 'opacity-60 bg-gray-50'} ${client.isDefaulter ? 'border-red-200' : ''}`}
        >
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="p-1 text-gray-400 hover:text-[#ff9900]"
              >
          ...
          <div className="flex justify-between items-center gap-3">
            <div className="grid grid-cols-5 gap-2 flex-1">
              <a
                ...
                className="flex justify-center p-2 bg-blue-50 text-blue-600 rounded-md"
              >
              ...
              <button
                ...
                className="flex justify-center p-2 bg-purple-50 text-purple-600 rounded-md"
              >
            ...
            <div className="text-right min-w-[80px]">
              ...
              <p
                className={`font-black text-sm ${client.outstanding > 0 ? 'text-red-500' : 'text-green-600'}`}
              >
